...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="">
                    ...
                    <div class="flex h-16 justify-between items-center">
                        <div class="flex items-center">
                            <a href="/" class="inline-block">
                              <img class="w-56" loading="lazy" src="https://laravel-courses.com/img/logo.png?1.0" alt="Logo">
                            </a>
                        ...
                        <div class="flex items-center">
                          @if(Auth::check())
                            ...
                            <form action="{{route('logout')}}" method="post">
                              @csrf
                            <button class="text-sm text-red-500 font-semibold  hover:text-gray-900 inline-block ml-4" type="submit" >Logout</button>
        ...
        <footer class=" bg-dark ">
            <div class="">
                <div class="bg-dark pt-[94px] relative w-full">
            ...
            <div class="container flex justify-between pb-[50px]">
              <div>
                ...
                <ul class="mt-5">
                  ...
                  <li class="mb-2">
                    <a href="{{route('archive',['series','view.js'])}}" class="text-links text-gray-100 text-base before:text-gray-100">Vue.js</a>
                  </li>
                </ul>
              </div>
              <div>
