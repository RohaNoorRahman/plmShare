        ...
        <div class="container">
          ...
          <nav class="flex mt-0">
              <ol role="list" class="flex items-center space-x-0.5">
                <li>
                  <div class="-m-1">
                    <a href="{{route('home')}}" class="p-1 ml-0.5 text-base font-medium text-gray-400 ring-0 rounded-md focus:outline-none  focus:text-gray-900 focus:ring-gray-900 hover:text-gray-700"> Home </a>
                  </div>
                </li>
                <li>
                  <div class="flex items-center">
                    ...
                    <div class="-m-1">
                      <a href="{{route('courses')}}" class="p-1 ml-0.5 text-base font-medium text-gray-400 rounded-md focus:outline-none  focus:text-gray-900 focus:ring-gray-900 hover:text-gray-700"> Courses </a>
                    </div>
                  </div>
                </li>
                <li>
                  <div class="flex items-center">
                    ...
                    <div class="-m-1" >
                      <a href="{{route('course',$course->slug)}}" class="p-1 ml-0.5 text-base font-medium text-gray-400 rounded-md focus:outline-none  focus:text-gray-900 focus:ring-gray-900 hover:text-gray-700"> {{$course->name}} </a>
                    </div>
                  </div>
                </li>
              </ol>
          ...
          <div class="flex mt-8">
              ...
              <div class="mt-2 w-2/3 border-gray-100 border-r pr-10 pb-0 border-b-0">
                <div class="flex">
                  <h1 class="text-3xl font-semibold text-gray-900"> {{$course->name}} </h1>
                </div>
                ...
                <div class="rounded-sm mt-8 shadow-sm bg-white">
                  <img src="{{$course->img}}" class="w-full " alt="{{$course->name}}">
                  <div class="p-6">
                ...
                <h2 class="mt-4 pt-4 text-lg font-bold text-gray-900 mb-7">Reviews</h2>

                @if (count($course->reviews) >0)
                @foreach($course->reviews as $review)
                  <div class="mb-6 bg-white p-4">
                    <p class="pb-3 text-gray-500">{{$review->comment }}</p>
                    <h3 class="text-gray-700 font-semibold">{{$review->user->name}}</h3>
                  </div>
